...
class MyTFLiteModule(reactContext: ReactApplicationContext) : ReactContextBaseJavaModule(reactContext) {
    ...
    init {
        try {
            ...
            // Apple
            appleDiseaseLabels = loadLabels("apple_labels.txt")
            appleDiseaseTflite = Interpreter(loadModelFile("apple_model_MobileNetV3Large.tflite"))
            try {
            ...
            // Corn
            cornDiseaseLabels = loadLabels("corn_labels.txt")
            cornDiseaseTflite = Interpreter(loadModelFile("corn_model_MobileNetV3Large.tflite"))
            try {
            ...
            // Grape
            grapeDiseaseLabels = loadLabels("grape_labels.txt")
            grapeDiseaseTflite = Interpreter(loadModelFile("grape_model_MobileNetV3Large.tflite"))
            try {
            ...
            // Potato
            potatoDiseaseLabels = loadLabels("potato_labels.txt")
            potatoDiseaseTflite = Interpreter(loadModelFile("potato_model_MobileNetV3Large.tflite"))
            try {
            ...
            // Tomato
            tomatoDiseaseLabels = loadLabels("tomato_labels.txt")
            tomatoDiseaseTflite = Interpreter(loadModelFile("tomato_model_MobileNetV3Large.tflite"))
            try {
